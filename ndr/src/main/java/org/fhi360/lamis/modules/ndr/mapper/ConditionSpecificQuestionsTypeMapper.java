...
public class ConditionSpecificQuestionsTypeMapper {
    ...
    public ConditionSpecificQuestionsType conditionSpecificQuestionsType(long patientId) {
        ...
        query = "SELECT c.*, description regimen FROM clinic c LEFT OUTER JOIN regimen r ON r.id = regimen_id WHERE patient_id = ? AND commence = true and date_visit  between '1901-01-01' and " +
