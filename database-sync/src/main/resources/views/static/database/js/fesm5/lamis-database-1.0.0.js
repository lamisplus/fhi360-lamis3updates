...
import { MatInputModule, MatIconModule, MatCardModule, MatSelectModule, MatButtonModule, MatProgressBarModule, MatTableModule, MatListModule } from '@angular/material';
...
var ModuleUpdateService = /** @class */ (function () {
    ...
    ModuleUpdateService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ModuleUpdateService_Factory() { return new ModuleUpdateService(ɵɵinject(HttpClient), ɵɵinject(SERVER_API_URL_CONFIG)); }, token: ModuleUpdateService, providedIn: "root" });
...
export { ModuleUpdatesModule, DatabaseSyncComponent as ɵa, ModuleUpdatesComponent as ɵb, ModuleUpdateService as ɵc, ROUTES as ɵd };
