(function (global, factory) {
...
}(this, function (exports, core, http, rxjs, webCore, operators, moment_, adfCore, common, material, router, core$1, forms, ngxDatatable, ng2Validation, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var BiometricService = /** @class */ (function () {
        ...
        BiometricService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function BiometricService_Factory() { return new BiometricService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG), core.ɵɵinject(webCore.AuthServerProvider)); }, token: BiometricService, providedIn: "root" });
