...
import { DATE_FORMAT, SERVER_API_URL_CONFIG, AuthServerProvider, AppLoaderService, MatDateFormatModule } from '@lamis/web-core';
import { map } from 'rxjs/operators';
import * as moment_ from 'moment';
import { NotificationService, CoreModule } from '@alfresco/adf-core';
import { CommonModule } from '@angular/common';
import { MatIconRegistry, MatInputModule, MatIconModule, MatCardModule, MatSelectModule, MatButtonModule, MatProgressBarModule, MatTableModule, MatListModule } from '@angular/material';
...
var BiometricService = /** @class */ (function () {
    ...
    BiometricService.prototype.saveTemplates = function (biometrics) {
        var _this = this;
        biometrics = biometrics.map(function (biometric) { return _this.convertDateFromClient(biometric); });
    ...
    BiometricService.ctorParameters = function () { return [
        { type: HttpClient },
        { type: undefined, decorators: [{ type: Inject, args: [SERVER_API_URL_CONFIG,] }] },
        { type: AuthServerProvider }
    ]; };
    BiometricService.ngInjectableDef = ɵɵdefineInjectable({ factory: function BiometricService_Factory() { return new BiometricService(ɵɵinject(HttpClient), ɵɵinject(SERVER_API_URL_CONFIG), ɵɵinject(AuthServerProvider)); }, token: BiometricService, providedIn: "root" });
...
var BiometricEditComponent = /** @class */ (function () {
        ...
        this.biometricService.getPatient(patientId).subscribe(function (res) {
            ...
            _this.biometricService.findByPatient(_this.patient.id).subscribe(function (res) {
                if (res.body) {
                    ...
                    _this.fingers = _this.fingers.filter(function (f) { return !_this.biometrics.map(function (b) { return b.templateType; }).includes(f); });
                }
            });
        });
        this.biometricService.getReaders().subscribe(function (res) { return _this.readers = res; });
    };
    BiometricEditComponent.prototype.enroll = function () {
        ...
        this.biometricService.identify(this.reader.id).subscribe(function (res) {
            ...
            if (res.message === 'PATIENT_NOT_IDENTIFIED') {
                ...
                _this.biometrics = _this.biometrics.filter(function (b) { return b.templateType !== _this.finger; });
    ...
    BiometricEditComponent.ctorParameters = function () { return [
...
var BiometricsModule = /** @class */ (function () {
    ...
    BiometricsModule.ctorParameters = function () { return [
