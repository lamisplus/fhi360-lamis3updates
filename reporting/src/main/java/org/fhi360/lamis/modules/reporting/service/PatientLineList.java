...
public class PatientLineList {
    ...
    public List<PatientVM> listOfPatients(PatientQueryParams params) {
        ...
        String query = "SELECT * FROM (" +
                "SELECT id, hospital_num, surname, other_names, gender, date_birth, status_at_registration status_registration, address, phone, date_started, date_registration," +
                ...
                "AND date_visit <= CURRENT_DATE AND ph.archived = false AND l.archived = false ORDER BY date_visit DESC, duration DESC LIMIT 1) ltfu," +
