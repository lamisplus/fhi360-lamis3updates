(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@lamis/web-core'), require('moment'), require('@stomp/ng2-stompjs'), require('@angular/platform-browser'), require('file-saver'), require('@angular/common'), require('@angular/material'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@angular/forms'), require('@syncfusion/ej2-angular-dropdowns'), require('@syncfusion/ej2-angular-calendars')) :
    typeof define === 'function' && define.amd ? define('lamis-reporting-1.2.0', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'moment', '@stomp/ng2-stompjs', '@angular/platform-browser', 'file-saver', '@angular/common', '@angular/material', '@angular/router', 'rxjs', 'rxjs/operators', '@angular/forms', '@syncfusion/ej2-angular-dropdowns', '@syncfusion/ej2-angular-calendars'], factory) :
    (global = global || self, factory((global['lamis-reporting-1'] = global['lamis-reporting-1'] || {}, global['lamis-reporting-1']['2'] = global['lamis-reporting-1']['2'] || {}, global['lamis-reporting-1']['2']['0'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.moment_, global.ng2Stompjs, global.ng.platformBrowser, global.fileSaver, global.ng.common, global.ng.material, global.ng.router, global.rxjs, global.rxjs.operators, global.ng.forms, global.ej2AngularDropdowns, global.ej2AngularCalendars));
}(this, function (exports, core, http, webCore, moment_, ng2Stompjs, platformBrowser, fileSaver, common, material, router, rxjs, operators, forms, ej2AngularDropdowns, ej2AngularCalendars) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ReportService = /** @class */ (function () {
        ...
        ReportService.prototype.patientLineList = function (params) {
            ...
            params.dateStartedBegin = params.dateStartedBegin != null && params.dateStartedBegin.isValid() ? params.dateStartedBegin.format(webCore.DATE_FORMAT) : null;
            params.dateStartedEnd = params.dateStartedEnd != null && params.dateStartedEnd.isValid() ? params.dateStartedEnd.format(webCore.DATE_FORMAT) : null;
        ...
        ReportService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ReportService_Factory() { return new ReportService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG)); }, token: ReportService, providedIn: "root" });
    ...
    var DataConversionComponent = /** @class */ (function () {
        ...
        DataConversionComponent.prototype.convert = function () {
            ...
            this.reportService.convertData(this.selectedFacilities, this.report, this.labTest).pipe(operators.catchError(function (err) {
                _this.running = false;
                _this.finished = true;
                return rxjs.EMPTY;
        ...
        DataConversionComponent = __decorate([
            core.Component({
            ...
            __metadata("design:paramtypes", [ng2Stompjs.RxStompService, ReportService])
    ...
    exports.ɵ3 = ɵ3;
    exports.ɵ4 = ɵ4;
    exports.ɵa = DataConversionComponent;
    exports.ɵb = PatientLineListComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=lamis-reporting-1.2.0.umd.js.map
