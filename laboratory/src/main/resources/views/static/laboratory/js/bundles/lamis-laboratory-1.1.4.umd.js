(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('lamis-laboratory-1.1.4', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'rxjs/operators', 'moment', '@alfresco/adf-core', '@angular/common', '@angular/material', '@angular/router', '@covalent/core', 'rxjs', '@swimlane/ngx-datatable', '@angular/forms', 'ng2-validation'], factory) :
    (global = global || self, factory((global['lamis-laboratory-1'] = global['lamis-laboratory-1'] || {}, global['lamis-laboratory-1']['1'] = global['lamis-laboratory-1']['1'] || {}, global['lamis-laboratory-1']['1']['4'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.rxjs.operators, global.moment_, global.adfCore, global.ng.common, global.ng.material, global.ng.router, global.core$1, global.rxjs, global.ngxDatatable, global.ng.forms, global.ng2Validation));
    ...
    var LaboratoryEditComponent = /** @class */ (function () {
                    ...
                    _this.laboratoryService.getLinesByLaboratory(_this.entity.id)
                        ...
                        _this.rows = res.map(function (r) {
                            _this.laboratoryService.getLabTestById(r.labTest.id).subscribe(function (res) {
                                if (!_this.tests.map(function (r) { return r.id; }).includes(r.labTest.id)) {
        ...
        LaboratoryEditComponent.prototype.save = function () {
            ...
            this.rows.forEach(function (line) {
                ...
                if ((line.labTest.id === 16 || line.labTest.id === 1) && _this.entity.dateAssay && result < 0) {
                    _this._dialogService.openAlert({
        ...
        LaboratoryEditComponent.prototype.testChanged = function (event) {
            ...
            this.selectedTests.forEach(function (labTest) {
                ...
                _this.rows = _this.rows.filter(function (row) { return _this.selectedTests.map(function (test) { return test.id; }).includes(row.labTest.id); });
                _this.labTestIds.forEach(function (id) {
                    if (!_this.rows.map(function (r) { return r.labTest.id; }).includes(id)) {
...
//# sourceMappingURL=lamis-laboratory-1.1.4.umd.js.map
